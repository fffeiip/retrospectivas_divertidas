...
function App() {
  return (
    <div className="h-screen flex-col text-white">
      ...
      <div className="bg-green-100 min-h-screen flex-1 text-black flex items-center justify-center">
        <p className="mx-4 text-4xl text-center">
